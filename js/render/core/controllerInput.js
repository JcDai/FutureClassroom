...
// export let controllerPosition = { left: [], right: [] };
...
export let updateController = (avatar, buttonInfo) => {
  ...
  // controllerPosition.left = avatar.leftController.position;
  // controllerPosition.right = avatar.rightController.position;
...
export function ControllerBeam(model, hand) {
  ...
  // }
  // else {
  //   this.beam.add('tubeZ').color(10, 0, 0)
  //     .move(0, 0, -0.501)
  //     .scale(.01, .01, 0.5);
  // }
